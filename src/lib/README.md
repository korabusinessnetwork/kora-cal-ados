...
| `modeloDeLinguagem/` | Os fornecedores de modelo de linguagem por marca (D13): a lista grátis, a guarda do endereço da API própria, o custo estimado e o resumo do gasto. Puro, dividido entre a tela e `api/` |
