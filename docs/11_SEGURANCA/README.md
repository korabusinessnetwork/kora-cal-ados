...
| `proposta-correcao-rls.md` | Histórico da decisão que corrigiu a recursão da policy, o onboarding travado e a ausência de policy de Storage (BUG-006..009). Implementada em `supabase/migrations/20260812_correcao_rls_e_storage.sql`, **aplicada e provada em 2026-08-13** (isolamento 8/8) |
