...
- [ ] T17 Conferência em navegador virando teste | trilha: front | depende: T14 | pronto quando: existe um teste que sobe o Chrome headless, monta o calçado e **mede a cor na tela contra o hex escolhido**, pulável quando não houver Chrome (o molde de `skipIf(!temAmbiente)` dos testes de banco). Descoberta em 2026-09-11: "não dá para testar em 3D" era verdade sobre o jsdom, não sobre a máquina, e a passada manual mediu os 5 itens sem instalar dependência nenhuma. **É o primeiro teste do projeto que olha cor na TELA e não cor no arquivo**, que é literalmente o princípio nº1. Custo zero em dependência, e o risco a pesar na spec é a fragilidade de um teste que depende de navegador instalado
